(function () {
    ...
    angular.module('myApp').controller("TurismoController", ['$http', '$scope', function ($http, $scope) {

        var baseUrl = 'https://api.jsonbin.io/b/5cff368e58196b429f520bce/1';
        ...
        $stateProvider.state({
            ...
            controllerAs: '$ctrl',
            template: `
                <div ng-controller="TurismoController">
                <div>
  <div class="container">
      <div class="row">
          ...
          <div class="col-md-4 d-flex justify-content-center justify-content-md-end justify-content-lg-end justify-content-xl-end"><button
                 ui-sref="turismomap" class="btn btn-primary btn-lg " type="button">{{'MAP' | translate}}</button></div>
      </div>
  </div>
</div>
<div class="container">
      ...
      <div class="col-md-6 no-padding lib-item" data-category="view" ng-repeat='x in data.features' >
          <div class="lib-panel">
              <div class="row box-shadow">
                  <div class="col-md-6">
                      <img class="lib-img-show" src="{{x.attributes.Image}}">
                  </div>
                  <div class="col-md-6">
