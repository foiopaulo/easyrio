(function () {
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 d-md-flex align-items-md-center justify-content-end" style="padding-right: 0px;"><button
                       ui-sref="map" class="btn btn-primary btn-lg " type="button">{{'LIST' | translate}}</button></div>
            </div>
        </div>
    </div>
    ...
    <iframe src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d14699.61301212221!2d-43.18756833753879!3d-22.916939027671788!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1seventos!5e0!3m2!1spt-BR!2sbr!4v1560286169874!5m2!1spt-BR!2sbr" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
            </div>
        </div>
    </div>
