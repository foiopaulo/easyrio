(function () {
    ...
    angular.module('myApp').controller("EsportesController", ['$http', '$scope', function ($http, $scope) {

            var baseUrl = 'https://api.jsonbin.io/b/5d01e1ab2132b7426d005153';
        ...
        .config(['$stateProvider', ($stateProvider) => {
            $stateProvider.state({
                name: 'esportes',
                url: '/esportes',
                controller: EsportesController,
                controllerAs: '$ctrl',
                template: `
                <div ng-controller="EsportesController">
                <div>
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 d-flex justify-content-center justify-content-md-end justify-content-lg-end justify-content-xl-end">
            <button ui-sref="esportesmap" class="btn btn-primary btn-lg " type="button">{{'MAP' | translate}}</button></div>
        </div>
    </div>
</div>
        ...
        <div class="col-md-6 no-padding lib-item" data-category="view" ng-repeat='x in data.features' >
            <div class="lib-panel">
                <div class="row box-shadow">
                    <div class="col-md-6">
                        <img class="lib-img-show" alt="esportes" src="{{x.attributes.Image}}">
                    </div>
                    <div class="col-md-6">
